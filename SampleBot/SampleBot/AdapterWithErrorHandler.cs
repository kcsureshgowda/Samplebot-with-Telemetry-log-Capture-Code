...
namespace SampleBot
{
    ...
    {
        public AdapterWithErrorHandler(TranscriptLoggerMiddleware transcriptLoggerMiddleware, BotFrameworkAuthentication auth, ILogger<IBotFrameworkHttpAdapter> logger, ConversationState conversationState = default)
            : base(auth, logger)
        {
